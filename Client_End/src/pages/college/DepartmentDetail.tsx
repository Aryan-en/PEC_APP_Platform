...
export function DepartmentDetail() {
  ...
  useEffect(() => {
    ...
    const mockDepartment = {
      ...
      description: 'Core department for software systems and intelligent computing.',
      hod: 'Dr. R. K. Sharma',
    };

    const mockFaculty = [
      { id: 'f-1', fullName: 'Dr. Priya Mehta', designation: 'Professor', employeeId: 'FAC-022', role: 'faculty' },
      { id: 'f-2', fullName: 'Dr. Aman Verma', designation: 'Associate Professor', employeeId: 'FAC-031', role: 'faculty' },
    ];

    const mockStudents = [
      { id: 's-1', fullName: 'Aarav Sharma', enrollmentNumber: 'CS2022001', semester: 6 },
      { id: 's-2', fullName: 'Naina Gupta', enrollmentNumber: 'CS2022002', semester: 6 },
    ];

    const mockCourses = [
      { id: 'c-1', code: 'CS301', name: 'Database Management Systems', credits: 4 },
      { id: 'c-2', code: 'CS305', name: 'Computer Networks', credits: 3 },
      { id: 'c-3', code: 'CS401', name: 'Machine Learning', credits: 4 },
    ];
  ...
  const getSlotsContent = (day: string, slot: string) => {
