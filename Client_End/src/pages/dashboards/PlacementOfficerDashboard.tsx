...
export function PlacementOfficerDashboard() {
  ...
  useEffect(() => {
    // Set static mock data for demo mode
    setStats({
      placed: 856,
      recruiters: 142,
      jobs: 320,
    ...
    setRecentPlacements([
      { id: '1', studentName: 'Aryan Singh', companyName: 'Google', jobTitle: 'Software Engineer', status: 'hired' },
      { id: '2', studentName: 'Priya Sharma', companyName: 'Microsoft', jobTitle: 'SDE 1', status: 'hired' },
      { id: '3', studentName: 'Rahul Kumar', companyName: 'Amazon', jobTitle: 'Frontend Engineer', status: 'hired' },
      { id: '4', studentName: 'Neha Gupta', companyName: 'Atlassian', jobTitle: 'Backend Engineer', status: 'hired' },
    ]);

    setUpcomingDrives([
      { id: 'd1', companyName: 'TCS', role: 'System Engineer', date: { toDate: () => new Date('2025-02-15') }, registeredCount: 450, status: 'upcoming' },
      { id: 'd2', companyName: 'Infosys', role: 'Specialist Programmer', date: { toDate: () => new Date('2025-02-18') }, registeredCount: 380, status: 'upcoming' },
      { id: 'd3', companyName: 'Wipro', role: 'Project Engineer', date: { toDate: () => new Date('2025-02-22') }, registeredCount: 512, status: 'upcoming' },
      { id: 'd4', companyName: 'Cognizant', role: 'GenAI Developer', date: { toDate: () => new Date('2025-03-01') }, registeredCount: 290, status: 'upcoming' },
    ]);
