...
export function RecruiterDashboard() {
  ...
  useEffect(() => {
    ...
    setJobs([
      { id: '1', title: 'Frontend Developer', location: 'Bangalore / Hybrid', status: 'active', daysLeft: 10 },
      { id: '2', title: 'Backend Engineer', location: 'Remote', status: 'closing', daysLeft: 2 },
    ]);

    setRecentCandidates([
      { id: 'c1', studentName: 'Aditya Patel', studentDepartment: 'Computer Science', jobTitle: 'Frontend Developer', cgpa: 9.1 },
      { id: 'c2', studentName: 'Priya Sharma', studentDepartment: 'Electrical', jobTitle: 'Backend Engineer', cgpa: 8.8 },
      { id: 'c3', studentName: 'Rahul Kumar', studentDepartment: 'Mechanical', jobTitle: 'Product Manager', cgpa: 8.5 },
    ]);
