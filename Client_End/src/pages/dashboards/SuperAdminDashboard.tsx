...
export function SuperAdminDashboard() {
  ...
  useEffect(() => {
    // Mocked data keeps this dashboard functional without backend coupling.
    const seedOrganizations: Organization[] = [
      { id: 'org-1', name: 'Punjab Engineering College', type: 'engineering', totalUsers: 1240, status: 'active', slug: 'demo' },
      { id: 'org-2', name: 'IIT Delhi', type: 'technical', totalUsers: 8420, status: 'active', slug: 'iitd' },
      { id: 'org-3', name: 'NIT Warangal', type: 'technical', totalUsers: 6100, status: 'pending', slug: 'nitw' },
      { id: 'org-4', name: 'MIT Manipal', type: 'private', totalUsers: 5300, status: 'suspended', slug: 'mit-manipal' },
      { id: 'org-5', name: 'Thapar Institute', type: 'private', totalUsers: 4100, status: 'active', slug: 'thapar' },
    ];
  ...
  const stats = {
    ...
    totalUsers: organizations.reduce((sum, org) => sum + (org.totalUsers || 0), 0),
  };
