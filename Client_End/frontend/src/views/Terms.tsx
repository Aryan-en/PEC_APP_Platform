        ...
        >
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using the PEC App website and application, you accept and agree to be bound by the terms
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              PEC App's website for personal, non-commercial transitory viewing only. This is the grant of a license, not
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The materials on PEC App's website are provided "as is". PEC App makes no warranties, expressed or
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              For any questions about these Terms, please contact us at legal@PEC App.app
            </p>
          </section>
        </motion.div>
      </div>
