        ...
        <motion.div variants={item} className="card-elevated p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="platform-name" defaultValue="PEC App" className="mt-1" />
            </div>
            <div>
              <Label htmlFor="support-email">Support Email</Label>
              <Input id="support-email" type="email" defaultValue="support@PEC App.edu" className="mt-1" />
            </div>
            <div>
        ...
        <motion.div variants={item} className="card-elevated p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="smtp-host" defaultValue="smtp.PEC App.edu" className="mt-1" />
            </div>
            ...
            <div>
              ...
              <Input id="from-email" defaultValue="noreply@PEC App.edu" className="mt-1" />
            </div>
          </div>
        </motion.div>
