...
import { doc, getDoc, setDoc, where, serverTimestamp } from "firebase/firestore";
...
export default function CollegeSettings({ embedded }: Props) {
  ...
  const fetchSettings = async () => {
    try {
      setLoading(true);
      const settingsRef = doc(db, 'collegeSettings', 'main' as string);
      ...
      <Card className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/20">
        <CardContent className="pt-6">
          <p className="text-sm text-blue-900 dark:text-blue-200">
            ℹ️ <strong>Note:</strong> These settings will be displayed across the PEC App platform including invoices, 
