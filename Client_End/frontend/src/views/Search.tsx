                  ...
                  <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                       {results.pages.slice(0, 6).map(page => (
                        <PageCard key={page.path} page={page} router.push={router.push} />
                      ))}
                    </div>
                  </section>
                )}
                  ...
                  <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                       {results.subjects.slice(0, 4).map(sub => (
                        <SubjectCard key={sub.id} subject={sub} router.push={router.push} />
                      ))}
                    </div>
                  </section>
                )}
                  ...
                  <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {results.users.slice(0, 6).map(user => (
                        <UserCard key={user.id} user={user} router.push={router.push} />
                      ))}
                    </div>
                  </section>
                )}
                  ...
                  <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                       {results.jobs.slice(0, 4).map(job => (
                        <JobCard key={job.id} job={job} router.push={router.push} />
                      ))}
                    </div>
                  </section>
                )}
                  ...
                  <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                       {results.drives.slice(0, 4).map(drive => (
                        <DriveCard key={drive.id} drive={drive} router.push={router.push} />
                      ))}
                    </div>
                  </section>
                )}
...
function UserCard({ user, router.push }: { user: any, router.push: any }) {
  return (
...
function JobCard({ job, router.push }: { job: any, router.push: any }) {
  return (
...
function DriveCard({ drive, router.push }: { drive: any, router.push: any }) {
  return (
...
function PageCard({ page, router.push }: { page: any, router.push: any }) {
  return (
...
function SubjectCard({ subject, router.push }: { subject: any, router.push: any }) {
  return (
