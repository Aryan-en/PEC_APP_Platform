...
const articles = [
  { 
    icon: Rocket, 
    title: 'Welcome to PEC App', 
    description: 'An introduction to the platform and its capabilities', 
    readTime: '3 min',
    content: `PEC App is a comprehensive Campus Operating System designed to streamline every aspect of university life. From academic tracking to late-night snacking, it brings everything into one unified dashboard.
...
Our goal is to reduce administrative friction and let you focus on what matters most: your growth.`
  ...
  { 
    ...
    readTime: '5 min',
    content: `The Student Dashboard is your central hub. Here's how to router.push it:
...
Admins can access these through the specific 'Admin' labeled links in the sidebar.`
  ...
  { 
    ...
    readTime: '3 min',
    content: `Navigation in PEC App is designed for speed:
...
• **Breadcrumbs**: Use the path at the top to quickly router.push back to parent categories.
