...
import {  collection, doc, addDoc, updateDoc, deleteDoc, query, orderBy , onSnapshot, arrayUnion, arrayRemove } from 'firebase/firestore';
...
export default function Clubs() {
  ...
  const handleUpdateClub = async () => {
    ...
    try {
      await updateDoc(doc(db, 'clubs', editingClub.id as string), {
        ...newClub,
        updatedAt: new Date(),
      });
  ...
  const handleDeleteClub = async (clubId: string) => {
    ...
    try {
      await deleteDoc(doc(db, 'clubs', clubId as string));
