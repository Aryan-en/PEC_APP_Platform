...
import {  collection, doc, getDocs, addDoc, updateDoc, query, where, limit, orderBy, serverTimestamp , onSnapshot } from 'firebase/firestore';
...
export default function PlacementApplications() {
  ...
  const handleSaveNote = async () => {
    ...
    try {
      await updateDoc(doc(db, 'applications', currentAppForNote.id as string), {
        notes: noteContent,
        updatedAt: serverTimestamp(),
      });
