...
export default function ApplyInstitution() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'users', userCredential.user?.uid as string), {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            Thank you for applying to join PEC App. Our team will review your application and get back to you within 24-48 hours.
          </p>
