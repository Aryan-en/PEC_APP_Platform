        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/">
              ...
              >
                <img src="/logo.png" alt="PEC App" className="h-12 w-auto" />
              </motion.div>
            </Link>
        ...
        <div className="max-w-6xl mx-auto relative z-10 w-full">
          ...
          >
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6" style={{ fontFamily: "'Monument Extended', serif" }}>
              Why{" "}
              <span className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">PEC App</span>
            </h2>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                q: "What systems can PEC App integrate with?",
              ...
              },
              {
                ...
                a: "Yes, PEC App has a comprehensive REST API with full documentation. Perfect for custom development.",
              },
              {
                q: "Is PEC App GDPR compliant?",
                a: "Yes, PEC App is fully GDPR and FERPA compliant. All data is encrypted at rest and in transit. We're SOC 2 Type II certified.",
              },
              {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <p className="text-sm text-white/50">
              © 2025 PEC App. All rights reserved.
            </p>
