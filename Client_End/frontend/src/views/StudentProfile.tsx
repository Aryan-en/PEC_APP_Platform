...
import {  collection, doc, getDoc, getDocs, updateDoc, query, where, orderBy , deleteField } from 'firebase/firestore';
...
export function StudentProfile() {
  ...
  const handleConnect = async (type: 'github' | 'linkedin') => {
    ...
    try {
      ...
      await updateDoc(doc(db, 'studentProfiles', user?.uid as string), {
        [field]: cleanUsername
      });
          ...
          <div className="flex-1">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button size="sm" onClick={()=>router.push('/resume-builder')} >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="card-elevated p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Button onClick={()=>router.push('/courses')} variant="ghost" size="sm">
                    View All
