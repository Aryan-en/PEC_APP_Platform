...
const faqs = [
  {
    question: "What makes PEC App different from other college management systems?",
    answer:
      "PEC App is built by educators and technologists who actually understand college operations. Unlike generic ERPs, we focus on the real pain points - from simplifying attendance tracking to automating fee reminders. Everything is designed to save you time, not add more complexity.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! PEC App integrates seamlessly with popular tools you're already using - Google Classroom, payment gateways, library systems, and more. If you have a specific system, our team will build custom integrations to make everything work together.",
  },
  {
  ...
  {
    question: "Can PEC App grow with our institution?",
    answer:
      "Absolutely. Whether you're a small college today or planning to expand to multiple campuses, PEC App scales automatically. Add more departments, students, or features anytime without worrying about performance or additional setup.",
  },
  {
    question: "Can we try it before committing?",
    answer:
      "Yes! Get a 14-day free trial with full feature access - no credit card needed. Want to see it in action first? Book a personalized demo where we'll show you exactly how PEC App solves your college's specific challenges.",
  },
  {
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl">PEC App</span>
          </Link>
      ...
      <section className="pt-32 pb-20 px-6">
        ...
        >
          ...
          >
            PEC App combines student management, academics, finance, attendance,
          ...
          >
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: "'Monument Extended', serif" }}
              >
                Why Institutions Choose PEC App
              </h2>
      ...
      <section className="py-20 px-6 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              The principles that guide everything we do at PEC App.
            </p>
          </motion.div>
      ...
      <footer className="py-8 px-6 border-t border-border">
        <div className="container mx-auto text-center text-sm text-muted-foreground">
          <p>© 2024 PEC App. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
