        ...
        >
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              PEC App ("we", "us", "our" or "Company") operates the PEC App.app website and the PEC App application.
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you have any questions about this Privacy Policy, please contact us at privacy@PEC App.app
            </p>
          </section>
        </motion.div>
      </div>
