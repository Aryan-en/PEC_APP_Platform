...
export default function Onboarding() {
  ...
  const handleStudentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'studentProfiles', userId as string), {
        uid: userId,
        email: userEmail,
        fullName: userName,
        ...studentForm,
  ...
  const handleFacultySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'facultyProfiles', userId as string), {
        uid: userId,
        email: userEmail,
        fullName: userName,
        ...facultyForm,
  ...
  const handleAdminSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'collegeAdminProfiles', userId as string), {
        uid: userId,
        email: userEmail,
        fullName: userName,
        ...adminForm,
  ...
  const handlePlacementSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'placementOfficerProfiles', userId as string), {
        uid: userId,
        email: userEmail,
        fullName: userName,
        ...placementForm,
  ...
  const handleRecruiterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'recruiterProfiles', userId as string), {
        uid: userId,
        email: userEmail,
        fullName: userName,
        ...recruiterForm,
