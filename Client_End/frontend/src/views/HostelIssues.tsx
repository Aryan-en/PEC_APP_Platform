...
import {  collection, doc, addDoc, updateDoc, query, where, orderBy, serverTimestamp , onSnapshot, arrayUnion } from 'firebase/firestore';
...
export default function HostelIssues() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const issueRef = doc(db, 'hostelIssues', selectedIssue.id as string);
